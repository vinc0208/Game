...
void boxwtxt(uint8_t x1, uint8_t y1, uint8_t x2, uint8_t y2, char* txt, int style, int color){
	uint8_t i;

	int ul = 0, ur = 0, ll = 0, lr = 0, ho = 0, ver = 0, txt_l = 0, txt_r = 0;

	if (style == 1) {
		ul = 218, ur = 191, ll = 192, lr = 217, ho = 196, ver = 179, txt_l = 180, txt_r = 195;
	} else if (style == 2) {
		ul = 201, ur = 187, ll = 200, lr = 188, ho = 205, ver = 186, txt_l = 185, txt_r = 204;
	}
	...
	int back_line = y_diff - strlen(txt) - 8;
...
//spawns an enemy near the edge of the screen. might need a scaling hp factor down the line
